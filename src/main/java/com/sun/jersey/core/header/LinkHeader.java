...
public class LinkHeader {
    ...
    protected LinkHeader(LinkHeaderBuilder builder) {
        ...
        if (builder.parameters != null) {
            this.parameters = new MultivaluedStringMap(builder.parameters);
        }
    }
        ...
        if (parameters != null) {
            for (Entry<String, List<String>> e : parameters.entrySet()) {
                ...
                if (key.equals("anchor") || key.equals("title")) {
                    ...
                    StringBuilderUtils.appendQuoted(sb, values.get(0));
                    ...
                    for (String value : e.getValue()) {
                        sb.append(";").append(e.getKey()).append("=");                    
                        StringBuilderUtils.appendQuoted(sb, value);
                    }                    
                }
            }
        }
    ...
    private void checkNull() {
        if (parameters == null)
            parameters = new MultivaluedStringMap();
    }
